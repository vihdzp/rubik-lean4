...
/-- Turn right face. -/
abbrev R : Moves := [Orientation.R]
/-- Turn up face. -/
abbrev U : Moves := [Orientation.U]
/-- Turn front face. -/
abbrev F : Moves := [Orientation.F]

/-- Turn left face. -/
abbrev L : Moves := [Orientation.L]
/-- Turn down face. -/
abbrev D : Moves := [Orientation.D]
/-- Turn back face. -/
abbrev B : Moves := [Orientation.B]
...
solved state (of course, performing this sequence in reverse will solve the cube). -/
